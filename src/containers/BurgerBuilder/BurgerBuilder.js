    ...
    render() {
        ...
        return (
            <Aux>
                ...
                <BuildControls ingredients={this.state.ingredients} totalPrice={this.state.totalPrice}
                               changeIngredientsHandler={this.changeIngredientsHandler} disabled={disabledInfo}/>
            </Aux>
        );
    }
}
